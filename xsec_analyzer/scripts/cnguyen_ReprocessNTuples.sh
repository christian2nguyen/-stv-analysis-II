...
input_file=${config_dir}/files_to_process_cc0pi_fakedata_first3runs.txt
output_config=files_to_process_output_EventSelection_7_18_2025
output_dir=/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_7_21_2025
...
# echo $sample_type
  ...
  time ../bin/ProcessNTuples ${file_name} JOINTCC0pi ${output_file_name}
