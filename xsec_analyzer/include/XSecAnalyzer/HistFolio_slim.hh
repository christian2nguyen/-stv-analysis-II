...
// Copy from MINERVA's Histofolio , I want a catgory containor , and dont want to reinvent the wheel .. 
//==============================================================================
#pragma once
...
class HistFolio {
 public:
  ...
  template <class... HISTARGS>
   HistFolio(const std::vector<NamedCategory<CATEGORY>>& categories,
            std::string folio_name, std::vector<double> Bins1,
            std::vector<double> Bins2, const HISTARGS... hist_args);
...
HistFolio(const std::vector<NamedCategory<CATEGORY>>& categories,
  ...
  void ApplyColorPalette(
      MnvColors::EColorPalettes palette = MnvColors::k36Palette);
