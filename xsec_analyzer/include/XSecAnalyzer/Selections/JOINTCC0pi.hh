...
*/
 ...
 void SetVerbosal(int input ){verbosal = input;}
  ...
  //////////////////////////////////////////////////////
    ...
    const float MUON_P_MIN_WC_MOM_CUT_jointcc0pi =.600; // GeV/c
    const float MUON_P_MAX_WC_MOM_CUT_jointcc0pi = 1.2; // GeV/c
    const float MUON_Costheta_MIN_WC_CUT_jointcc0pi =0.8; // GeV/c
...
////////////////////////////////////////////////////////////
    ...
    // Water Cherenkov cuts and ANNIE accptence and threshold cuts 
    bool mc_muon_in_wc_mom_range_ ;
    bool mc_muon_in_wc_costheta_threshold_;
    ...
    bool sel_muon_passed_wc_costheta_;
