...
#include "XSecAnalyzer/AnalysisEvent_ANNIE.hh"
...
public:
  ...
  void apply_selection(AnalysisANNIE_Event* event );
  void apply_selection(AnalysisANNIE_Event_nuwro* event );
  void summary();
...
///////////////////////////////////////////////////////////////////////////
/// I want the opinion to Not label my varibles by the selection name
//////////////////////////////////////////////////////////////////////////
  template < typename T, typename S > void set_branch_nolabel( T*& var, S var_name )
  {
    std::string var_name_str( var_name );
    std::string full_name =  var_name_str;
    std::string leaf_list = full_name;
  ...
  // Overloaded version that takes a MyPointer argument instead
  template < typename T, typename S >
    void set_branch_nolabel( MyPointer<T>& u_ptr, S var_name )
  {
    T*& address = u_ptr.get_bare_ptr();
    this->set_branch_nolabel( address, var_name );
  }

  // Overloaded version that takes an rvalue reference to a pointer argument
  // instead (see, e.g., https://stackoverflow.com/a/5465371/4081973)
  template < typename T, typename S >
    void set_branch_nolabel( T*&& rval_ptr, S var_name )
  {
    T* address = rval_ptr;
    this->set_branch_nolabel( address, var_name );
  }
  ...
  /////////////////////////////////////////////////////////////////////////////////
  virtual bool selection( AnalysisANNIE_Event* event )=0;
  virtual int categorize_event( AnalysisANNIE_Event* event )=0;
  virtual void compute_reco_observables( AnalysisANNIE_Event* event )=0;
  virtual void compute_true_observables( AnalysisANNIE_Event* event )=0;
  virtual bool define_signal( AnalysisANNIE_Event* event )=0;
    /////////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////
    /////////////////////////////////////////////////////////////////////////////////
  virtual bool selection( AnalysisANNIE_Event_nuwro* event )=0;
  virtual int categorize_event( AnalysisANNIE_Event_nuwro* event )=0;
  virtual void compute_reco_observables( AnalysisANNIE_Event_nuwro* event )=0;
  virtual void compute_true_observables( AnalysisANNIE_Event_nuwro* event )=0;
  virtual bool define_signal( AnalysisANNIE_Event_nuwro* event )=0;
