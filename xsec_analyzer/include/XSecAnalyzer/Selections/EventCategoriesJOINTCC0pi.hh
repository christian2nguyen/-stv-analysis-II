...
#include <map>
#include <string>
#include "XSecAnalyzer/NamedCategory.hh"
#include "TH1.h"
#include "TH2.h"
#include <iostream>
...
enum EventCategoryJOINTCC0Pi {
 ...
 //,kNuMuBarCC = 12 remove nuMubarr CC
};
...
class EventCategoryInterpreter {
  ...
  ///////////////////////////////////////////////////////////////////////
 std::vector<NamedCategory<EventCategoryJOINTCC0Pi>>
         EventSelectionGroup_categories_ = {
                 NamedCategory<EventCategoryJOINTCC0Pi>({kUnknown},        "Unknown"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kSignalCCQE},     "Signal-(CCQE)"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kSignalCCMEC},    "Signal-(CCMEC)"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kSignalCCRES},    "Signal-(CCRES)"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kSignalOther},    "Signal-(Other)"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kNuMuCCNpi},      "#nu_{#mu}-CCN#pi"),
                // NamedCategory<EventCategoryJOINTCC0Pi>({kNuMuBarCC},       "#bar{#nu_{#mu}}-CC"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kNuMuCCOther},    "#nu_{#mu}-CCOther"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kNuECC},          "#nu_{e}-CC"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kNC},             "NC"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kOOFV},           "Out FV"),
                 NamedCategory<EventCategoryJOINTCC0Pi>({kOther},          "Other")
    };
//////////////////////////////////////////////////
//
//////////////////////////////////////////////////    
...
///////////////////////////////////////////////////////////////////////
    ...
    inline const std::vector<EventCategoryJOINTCC0Pi>  ReturnCategoryVector() const {
    std::vector<EventCategoryJOINTCC0Pi> output_vector{
    kSignalCCQE,
    kSignalCCMEC,
    kSignalCCRES,
    kSignalOther,
...
//
//////////////////////////////////////////////////
inline const std::map< EventCategoryJOINTCC0Pi, std::string >& label_map() const
...
//
//////////////////////////////////////////////////
inline std::string label( EventCategoryJOINTCC0Pi ec ) const
      { return event_category_to_label_map_.at( ec ); }

inline std::string Hist_label( EventCategoryJOINTCC0Pi ec ) const
...
//
//////////////////////////////////////////////////
inline int color_code( EventCategoryJOINTCC0Pi ec ) const
...
//
//////////////////////////////////////////////////
inline void set_mc_histogram_style( EventCategoryJOINTCC0Pi ec, TH1* mc_hist ) const
    {
...
//
//////////////////////////////////////////////////
inline void set_mc_histogram_style( EventCategoryJOINTCC0Pi ec, TH2* mc_hist ) const
    {
      int color = color_code( ec );
      mc_hist->SetFillColor( color );
      mc_hist->SetLineColor( color );
...
/*inline EventCategoryJOINTCC0Pi returnEventCategoryJOINTCC0PiType( int input) const{
      switch (input)
      {
        case 0:
        return kUnknown;
...
inline EventCategoryJOINTCC0Pi returnEventCategoryType( int input) const{
      switch (input)
      {
        case 0:
        return kUnknown;
...
//
//////////////////////////////////////////////////////////////////////////////// 
 inline bool IsSignal(EventCategoryJOINTCC0Pi input_Event)const {
       ...
       switch (input_Event)
      {
        ...
        default:
        std::cout<<"UNKNOWN EventCategoryJOINTCC0Pi when calling:IsSignal() input = "<< input_Event << std::endl;
        return false; 
        };
 }/////////////////////////////////
 //// ENd of Function
...
//////////////////////////////////////////////////
  EventCategoryInterpreter() {}
    ...
    std::map< EventCategoryJOINTCC0Pi, std::string > event_category_to_label_map_ = {
      { kUnknown, "Unknown" },
      ...
      { kOther, "Other" }
        ...
        std::map< EventCategoryJOINTCC0Pi, std::string > event_category_to_label_HistNamemap_ = {
      { kUnknown, "Unknown" },
      { kSignalCCQE, "Signal-(CCQE)" },
      { kSignalCCMEC, "Signal-(CCMEC)" },
      { kSignalCCRES, "Signal-(CCRES)" },
...
//////////////////////////////////////////////////
    ...
    std::map< EventCategoryJOINTCC0Pi, int > event_category_to_color_map_ = {
      { kUnknown, kGray },
      { kSignalCCQE, kGreen },
...
//////////////////////////////////////////////////
//Shared functionility , ANNIE and nuwro 
/////////////////////////////////////////////////
struct MRDRecoResult {
  double trackLengthInMRD;
  double exitx, exity, exitz;
  double dirx, diry, dirz;
  double cosTheta;
  double dist_mrd, dist_air;
  double dist_air_x, dist_air_y, dist_air_z;
