...
#include "Selections/EventCategoriesJOINTCC0pi.hh"
...
EventCategoryJOINTCC0Pi category_type; 
...
double pn_input,
double pn_mc_input,
EventCategoryJOINTCC0Pi category_type_input
);
...
#include "HistFolio_slim.hh"
public:
    TKI_Hists(const std::vector<NamedCategory<EventCategoryJOINTCC0Pi>>& categories_input, std::string Name, int trackN)
...
h_Pproton_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi> (categories_input, Histname, h_PbinEdges, " ;Events");
...
sprintf(Histname, "h_PCostheta_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_CosThetaproton_EventCategoryJOINTCC0Pi_= HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname,proton_Costheta_binEdges, " ;Events");
...
sprintf(Histname, "h_PCostheta_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_pT_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname, pT_binEdges, " ;Events");
sprintf(Histname, "h_pT_Resolution_Track_%i",trackN); 
...
sprintf(Histname, "h_delta_alphaT_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_delta_alphaT_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname,delta_alphaT_binEdges, " ;Events");
...
sprintf(Histname, "h_delta_pTx_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_delta_pTx_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname, delta_pTx_binEdges, " ;Events");
...
sprintf(Histname, "h_delta_pTy_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_delta_pTy_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi> (categories_input, Histname, delta_pTy_binEdges, " ;Events");
...
sprintf(Histname, "h_delta_phiT_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_delta_phiT_EventCategoryJOINTCC0Pi_  = HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname, delta_phiT_binEdges, " ;Events");
...
sprintf(Histname, "h_pn_Track_%i_EventCategoryJOINTCC0Pi",trackN); 
h_pn_EventCategoryJOINTCC0Pi_ = HistFolio<TH1D, EventCategoryJOINTCC0Pi>(categories_input, Histname, pn_binEdges, " ;Events");       
...
void WriteAll(TFile &outfile) const;
 ...
 std::string Name_; 
 int Ntracks_; 
 std::vector<EventCategoryJOINTCC0Pi> categories;
 ...
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_Pproton_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_CosThetaproton_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_pT_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_delta_alphaT_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_delta_pTx_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_delta_pTy_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_delta_phiT_EventCategoryJOINTCC0Pi_;
 HistFolio<TH1D, EventCategoryJOINTCC0Pi> h_pn_EventCategoryJOINTCC0Pi_;    
...
////////////////////////////////////////////////////////////////////////////////
std::map<std::pair<Binning2D, EventCategoryJOINTCC0Pi>, TH1D*> Construct_CategoryProjectionMap(
 TFile& fin,
 std::vector<Binning2D> Bin_vector,
 std::vector<EventCategoryJOINTCC0Pi> Stack_category, 
 char *BaseName );
////////////////////////////////////////////////////////////////////////////////
