...
public:
  ...
  int slice_orig_pass_id_ = BOGUS_INT;
  ...
  int nblips_saved_ = BOGUS_INT;
   ...
   MyPointer< std::vector<float> > blip_size_;
   MyPointer< std::vector<float> > blip_energy_;
   MyPointer< std::vector<float> > blip_true_g4id_;
   MyPointer< std::vector<float> > blip_true_energy_;
