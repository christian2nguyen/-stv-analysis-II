...
#include "../include/XSecAnalyzer/CrossSectionExtractor.hh"
...
std::cout<<" Testing Slice Plots "<< std::endl;
 ...
 // tutorial_slice_plots();
  ...
  //tutorial_slice_plots_withData("SelectionPlots_scheme1_test3", inputmakeFile, Plotting_Property_file,Bining_configFIle,true, false);
...
//
   tutorial_slice_plots_withData("SelectionPlots_test_inputAngle", inputmakeFile, Plotting_Property_file, Bining_configFIle,true,true);
