...
void DummySelection::define_additional_input_branches(TTree& etree){
 ...
 int DummySelection::categorize_event(AnalysisANNIE_Event_nuwro* event)  {
        // Do nothing
        return 0;  // Return a default integer value
    }

    bool DummySelection::selection(AnalysisANNIE_Event_nuwro* event)  {
        // Do nothing
        return false;  // Return a default boolean value
    }

    bool DummySelection::define_signal(AnalysisANNIE_Event_nuwro* event)  {
        // Do nothing
        return false;  // Return a default boolean value
    }

    void DummySelection::compute_reco_observables(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
    }

    void DummySelection::compute_true_observables(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
    }