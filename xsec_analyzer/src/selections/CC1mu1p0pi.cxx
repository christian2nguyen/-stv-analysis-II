...
void CC1mu1p0pi::define_additional_input_branches(TTree& etree){
  ...
  // Implementing pure virtual functions
    int CC1mu1p0pi::categorize_event(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
        return 0;  // Return a default integer value
    }

    bool CC1mu1p0pi::selection(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
        return false;  // Return a default boolean value
    }

    bool CC1mu1p0pi::define_signal(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
        return false;  // Return a default boolean value
    }

    void CC1mu1p0pi::compute_reco_observables(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
    }

    void CC1mu1p0pi::compute_true_observables(AnalysisANNIE_Event_nuwro* event) {
        // Do nothing
    }
