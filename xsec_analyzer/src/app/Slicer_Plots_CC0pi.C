 ...
 if(Plot_EXT == false){
  ...
  for ( size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx )
  {
   ...
   //  std::cout<<"stack Loop removed r crbegin() crend() "<< std::endl;
    ...
    {
      EventCategoryJOINTCC0Pi cat = iter->first;
...
std::string PDFoutputName,
std::string input_UnimakeFile,
std::string File_property, 
std::string input_Bin_config, 
bool turnOffChi2, 
bool SetUncernitytoSignalReponseOnly) {
 ...
 std::cout<<"Starting MCC9SystematicsCalculator"<< std::endl;
  ...
  std::cout<< "input_UnimakeFile = "<< input_UnimakeFile << std::endl;
 
  //UnivMake_FakeData_BDTdecided_1D_v5_pmucorrection.root
  auto* syst_ptr = new MCC9SystematicsCalculator(
  input_UnimakeFile.c_str(),
  "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/systcalc.conf" 
    );
 ...
 //
  ...
  std::cout<<"VaryBackgroundAndSignalDirectly ON "<< std::endl;
 ...
 std::cout<<"Getting Slices"<< std::endl;
  ...
  for ( size_t sl_idx = 0u; sl_idx < sb.slices_.size(); ++sl_idx )
  {
   ...
   //  std::cout<<"printing chi values "<< std::endl;
    ...
    TH1D* h_ext_input = (TH1D*)reco_ext_hist->Clone("slice_ext_input");
      ...
      int NDF;
    //////////////////////////
    // for 2D binwidth norm we want to include the bin width for the slice if we can bin with normalizing  , otherwise we want it one
    //////////////////////////
  ...
  if(other_var_width != 1){


}
   std::cout<<"On slice : "<< sl_idx  <<"   must be a 2D bin, adding slice width for bin normalzation :: width = "<<other_var_width << std::endl;
...
if(Scaleall){
  ...
  DrawStackMCandData_withLineBands(
    h_Data, 
    h_Total_MC,
    h_extBNB,
    slice_pred_stack,
...
std::cout<<" Drawing Slice Plots "<< std::endl;

  //tutorial_slice_plots();
  //tutorial_slice_plots_NODATAPOINTS();
  //std::string inputmakeFile = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/unimake_scheme1_v10.root" ;
  ...
  //std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/JOINTCC0pi_Scheme1_v10slice_config.txt";
  //tutorial_slice_plots_withData("SelectionPlots_scheme1_tlsest3", inputmakeFile, Plotting_Property_file,Bining_configFIle,true, false);
  //tutorial_slice_plots_2D_withData();
 // /exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/MCS_Panels_TrackLen_UNcontained_v1.root
   // /exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/MCS_Panel_Angle_Uncontained_v2.root
   // /exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/unimake_Panel_LiangMade.root
   std::string inputmakeFile = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/MCS_Panel_Angle_Uncontained_v2.root" ;
   std::string Plotting_Property_file = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/file_properties_EventSelection_12_21_2024_Plotting_newname.txt";
   std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/Muon_MCS_Panels_AngleSidesslice_config.txt";
   // std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-new/mybins_JOINTCC0pi_scheme2_v7slice_config.txt";


 
   std::string inputmakeFile_Tracklen = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/MCS_Panels_TrackLen_UNcontained_v1.root" ;
   std::string Bining_TklenPanels_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/Muon_MCS_Panels_Tracklenslice_config.txt";

   

//
   //tutorial_slice_plots_withData("../Output/SelectionPlots_test_inputAngle", inputmakeFile, Plotting_Property_file, Bining_configFIle, true,true);
  
bool turnOffChi2 = true; 
bool SetUncernitytoSignalReponseOnly = true; 
  ////////////////////////////////////////////////////////////////////
  // Make 
  ////////////////////////////////////////////////////////////////////
  
  std::vector<size_t> SliceBins_angle{6,7,8,9,10,11};
   std::string Slice_Bin_title = "Panel";
  
  std::vector<double> WindowZoomScale{1,1,1,1,50,1,1,1,1};
...
double max_XAxis_GridCanvas = 1.0;
double min_YAxis_GridCanvas = 0.0;
double max_YAxis_GridCanvas = 3.8;
  
 // tutorial_slice_PANELplots_withData(
 // "../Output/PanelPlot_angle_test_v1",
 //  inputmakeFile, Plotting_Property_file, 
 //  Bining_configFIle,  turnOffChi2, 
 //   SetUncernitytoSignalReponseOnly,
 //  "cos#theta_{#mu}",
 //  "Events",
 //  Slice_Bin_title,
 //   SliceBins_angle,
 //  multiply_Sides_costheta,
 ...
 //   WindowZoomScale);
   ...
   // tutorial_slice_PANELplots_withData(
   //   "../Output/PanelPlot_TKlen_test_v1",
   //   inputmakeFile_Tracklen, Plotting_Property_file, 
   //   Bining_TklenPanels_configFIle,  turnOffChi2, 
   //     SetUncernitytoSignalReponseOnly,
   //    "cos#theta_{#mu}",
   //    "Events",
   //    Slice_Bin_title,
   //     SliceBins_angle,
   //     multiply_Sides_trackLenght,
   //     min_XAxis_GridCanvas,
   //     max_XAxis_GridCanvas,
   //     min_YAxis_GridCanvas,
   //     max_YAxis_GridCanvas,
  ...
  //std::string inputmakeFile = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/unimake_MCS_panel_Angle.root" ;
  // std::string Plotting_Property_file = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/file_properties_EventSelection_12_21_2024_Plotting.txt";
  // std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/Muon_MCS_Panels_AngleSidesslice_config.txt";

   //tutorial_slice_plots_withData("SelectionPlots_Panel_Angle_Contained", inputmakeFile, Plotting_Property_file,Bining_configFIle,true,true);
  
  //std::string inputmakeFile = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/MUON_MCS_Panel_trackLen.root" ;
   //std::string Plotting_Property_file = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/file_properties_EventSelection_12_21_2024_Plotting.txt";
   //std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/Muon_MCS_Panels_Tracklenslice_config.txt";

   //tutorial_slice_plots_withData("SelectionPlots_Panel_Tklen_Contained", inputmakeFile, Plotting_Property_file,Bining_configFIle,false,true);
  
//std::string inputmakeFile = "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/EventSelection_12_21_2024/Muon_MCS_Panel_Subpanels.root" ;
//std::string Plotting_Property_file = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/file_properties_EventSelection_12_21_2024_Plotting.txt";
//std::string Bining_configFIle = "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/JOINTCC0pi_Scheme1_v10slice_config.txt";
  
  
  
  //tutorial_slice_plots_withData("SelectionPlots_Panel_subpanel_Contained", inputmakeFile, Plotting_Property_file,Bining_configFIle,false,true);
  ...
  /// Maybe this will help the segfault
  ...
  tutorial_slice_plots_withData(
    "mcc9val_plots",
    "/exp/uboone/data/users/cnguyen/CC0Pi_Selection/mcc9.10_val_v6/unimake_mcc9_v3.root",
    "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/file_properties_mcc9.19_val_v6.txt", 
   "/exp/uboone/app/users/cnguyen/stv-analysis-II/xsec_analyzer/configs/JOINTCC0pi_mc910_noblipsslice_config.txt", 
     turnOffChi2, 
     SetUncernitytoSignalReponseOnly);
...
void DrawPanelplot(std::vector<double> WindowZoomScale,
 ...
 GridCanvas *GC_Stack = new GridCanvas(uniq(), 3, 3, 800, 700);
 //GridCanvas *Stack_FracError = new GridCanvas(uniq(), 3, 4, 800, 550);
 char title_char[1024];
  auto BinVector = GetProjectBinVector();
   GC_Stack->SetBottomMargin(.00);
   GC_Stack->SetTopMargin(.01);
   GC_Stack->SetRightMargin(.01);
   GC_Stack->SetLeftMargin(.05);
   GC_Stack->ResetPads();
   	TLegend* lg1_Grid= new TLegend(0.12, 0.03, 1.03, 0.2 );
    lg1_Grid->SetNColumns(2);
    lg1_Grid->SetBorderSize(0);
    std::string MicroBooneTitle = MicroBooNE_LegendTitle_FullData();
    lg1_Grid->SetHeader(MicroBooneTitle.c_str());
    ...
    for ( auto sl_idx : SliceBins  )
  {
    ...
    TH1D* PanelClone = (TH1D*)slice_mc_plus_ext->hist_.get()->Clone("");
    PanelClone->SetLineColorAlpha(kBlack, 0.85);
    PanelClone->SetLineStyle(3); // Dashed line for upper bound
    PanelClone->SetLineWidth( 3 );
    lg1_Grid->AddEntry( PanelClone, "#muBooNE Tune [Sys+Stat]", "le" );
    }
   ...
   //  std::cout<<"stack Loop removed r crbegin() crend() "<< std::endl;
    ...
    {
      EventCategoryJOINTCC0Pi cat = iter->first;
      if(cat==EventCategoryJOINTCC0Pi::kUnknown) continue;
      TH1D* temp_mc_hist = category_hist->ProjectionY( "temp_mc_hist",
        cat_bin_index, cat_bin_index );
      temp_mc_hist->SetDirectory( nullptr );
   ...
   //  std::cout<<"printing chi values "<< std::endl;
    ...
    std::cout<<"Zoom In Times " << WindowZoomScale.at(Vector_index) << std::endl;
     ...
     drawString(BinStringMap[BinVector.at(Vector_index)], .033, false );
    auto pad = GC_Stack->cd(GridBins);
    			
    //sprintf(textplace, "#chi^{2}/ndf = %.2f / %i",chi2_result.chi2_ , chi2_result.num_bins_ );
    //lg2->AddEntry((TObject*)0, textplace, ""); // to put fit param
  
    		if ( WindowZoomScale.at(Vector_index) != 1)
		{
			
			TLatex la2(1 - pad->GetRightMargin() - 0.02,
				1 - pad->GetTopMargin() - .06,
		...
		// TLatex* Chi_sqrt_Latex = new TLatex;
		//TLatex *Chi_sqrt_Latex;
    //Chi_sqrt_Latex->SetTextSize(0.025);
		//sprintf(textplace, "#chi^{2}/ndf = %.2f / %i ",chi2_result.chi2_ , chi2_result.num_bins_ );
		//sprintf(textplace, "#chi^{2}/ndf = %.2f / %i ",99 , 9 );
		/*
		double inputs_X = pad->GetLeftMargin();
		double inputs_Y = pad->GetTopMargin();
		sprintf(textplace, "GridBins: %i  (%.2f,%.2f) ",GridBins,inputs_X,  inputs_Y);
		std::cout<<"GridBins = "<< GridBins << "inputs_X = "<< inputs_X << "inputs_Y "<<inputs_Y<< std::endl;
    Chi_sqrt_Latex->DrawLatex(inputs_X, inputs_Y, textplace);
     inputs_X =+.01; 
		 inputs_Y =+.01; 
    sprintf(textplace, "GridBins: %i  (%.2f,%.2f) ",GridBins,inputs_X,  inputs_Y);
    Chi_sqrt_Latex->DrawLatex(inputs_X, inputs_Y, textplace);
   ...
   // sprintf(textplace, "#chi^{2}/ndf = %.2f / %i ",99 , 9 );
   //	sprintf(textplace, "#chi^{2}/ndf = %.2f / %i ",chi2_result.chi2_ , chi2_result.num_bins_ );
   // Chi_sqrt_Latex.DrawLatex(1 - gPad->GetRightMargin() - 0.02,1 - gPad->GeååtTopMargin() - .062, textplace);		
       //delete Chi_sqrt_Latex; 
       Vector_index++;
  }// End of Grid Loop 
   ///////////////////////////////////////// 
...
////////////////////////////////////////////////////////
 ...
 GridCanvas *GridCanvas_TotalFracError = new GridCanvas(uniq(), 3, 3, 800, 700);
 TLegend* lg1_FracError_Grid= new TLegend( 0.3, 0.03, 1.02, 0.28  );
 lg1_FracError_Grid->SetTextSize(.025);
 lg1_FracError_Grid->SetNColumns(2);
 lg1_FracError_Grid->SetBorderSize(0);
   ...
   GridCanvas_TotalFracError->SetTopMargin(.02);
   GridCanvas_TotalFracError->SetRightMargin(.01);
   GridCanvas_TotalFracError->SetLeftMargin(.06);
 int GridBins = 0;
...
for ( auto sl_idx : SliceBins  )
{
 ...
 delete lg1_FracError_Grid; 
 ///////////////////////////
 GridCanvas *GridCanvas_DetFracError = new GridCanvas(uniq(), 3, 3, 800, 700);
 TLegend* lg2_FracError_Grid= new TLegend( 0.3, 0.03, 1.02, 0.28 );
 lg2_FracError_Grid->SetNColumns(2);
 lg2_FracError_Grid->SetBorderSize(0);
  GridCanvas_DetFracError->SetBottomMargin(.00);
  GridCanvas_DetFracError->SetTopMargin(.02);
  GridCanvas_DetFracError->SetRightMargin(.01);
  GridCanvas_DetFracError->SetLeftMargin(.05);
  GridBins = 0;
 for ( auto sl_idx : SliceBins  )
{
  const auto& slice = sb.slices_.at( sl_idx );
 ...
 delete lg2_FracError_Grid; 
 ////////////////////////////////////////
 GridCanvas *GridCanvas_CrossFracError = new GridCanvas(uniq(), 3, 3, 800, 700);
 TLegend* lg3_FracError_Grid= new TLegend( 0.3, 0.03, 1.02, 0.28  );
 lg3_FracError_Grid->SetNColumns(2);
 lg3_FracError_Grid->SetBorderSize(0);
  GridCanvas_CrossFracError->SetBottomMargin(.00);
  GridCanvas_CrossFracError->SetTopMargin(.02);
  GridCanvas_CrossFracError->SetRightMargin(.01);
  GridCanvas_CrossFracError->SetLeftMargin(.05);
  GridBins = 0;
 for ( auto sl_idx : SliceBins  )
{
  const auto& slice = sb.slices_.at( sl_idx );
 ...
 delete lg3_FracError_Grid; 
 ////////////////////////////////////////
 GridCanvas *GridCanvas_CrossTotalFracError = new GridCanvas(uniq(), 3, 3, 800, 700);
 TLegend* lg4_FracError_Grid= new TLegend( 0.3, 0.03, 1.02, 0.28  );
 lg4_FracError_Grid->SetNColumns(2);
 lg4_FracError_Grid->SetBorderSize(0);
 GridCanvas_CrossTotalFracError->SetBottomMargin(.00);
 GridCanvas_CrossTotalFracError->SetTopMargin(.02);
