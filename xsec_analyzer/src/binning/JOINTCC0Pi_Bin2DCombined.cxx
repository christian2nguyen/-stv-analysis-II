...
JOINTCC0Pi_Bin2DCombined::JOINTCC0Pi_Bin2DCombined() : BinSchemeBase( "JOINTCC0Pi_Bin2DCombined" ) {}

void JOINTCC0Pi_Bin2DCombined::DefineBlocks() {
  ...
  out_config_prefix_ = "JOINTCC0pi_2DCombined_v1";
