////#ifndef HISTFOLIO_SLIM_CPP
////#define HISTFOLIO_SLIM_CPP
#pragma once
#include "XSecAnalyzer/HistFolio_slim.hh"
#include "XSecAnalyzer/MnvColors.hh"
//#include <cassert>
//#include <exception>
//
...
HistFolio<HIST, CATEGORY>::HistFolio(const std::vector<NamedCategory<CATEGORY>>& categories,
                                          ...
                                          bool isVerticalBinningType,
                                          const HISTARGS... hist_args)
    : m_folio_name(folio_name),
      m_source_hist(new HIST(folio_name.c_str(), hist_args..., Bin_edges, isVerticalBinningType)) {
    for (const auto& cat : categories) AddComponentHist(cat);
}
...
void HistFolio<HIST, CATEGORY>::InitializeComponentHist(
  ...
  std::vector<int> fill_colors =
                   MnvColors::GetColors(MnvColors::k36Palette);
...
//removed PLOTUtil depends Plus these functions eat memory 
//==============================================================================
//
